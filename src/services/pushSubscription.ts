...
export class PushSubscriptionService {
  ...
  // ===============================================================
  // 🔥 Conversão: Base64 URL → Uint8Array
  // ===============================================================
  ...
  async subscribeUser(userId: string): Promise<boolean> {
    try {
      ...
      const arrayBufferKey = this.base64ToArrayBuffer(vapidPublicKey);
  ...
  async getVapidPublicKey(): Promise<string> {
    try {
      ...
      return "BE5XOZ2XI2b1J7tYXTpQ1OWKK09wAd3AbJW8SE9wTlXs8GEtEeTu-CQ_dXGIDB0uMSW3jApuCRbv5iF1aR3Ze4s";
    }
  }
